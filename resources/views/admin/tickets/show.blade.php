                ...
                <div class="col-md-5">
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <p>
                                Category: {{ Form::select('category',$categories,$ticket->category_id,['class'=>'form-control'])}}</p>
                            <p>
                                Status: {{ Form::select('status',$statuses,$ticket->status_id,['class'=>'form-control'])}}</p>
                            <p>
                                Priority:{{ Form::select('priority',$prioritys,$ticket->priority_id,['class'=>'form-control'])}}</p>
                            <p>Created: {{ $ticket->created_at->diffForHumans() }}</p>
                            <p>Last Updated: {{ $ticket->updated_at->diffForHumans() }}</p>

                            <div class="row">
                                <div class="col-md-6">
                                    <button type="submit" class="btn bg-purple"><i class="fa fa-btn fa-ticket"></i>
                                        Update Ticket
                                    </button>
                                    {!! Form::close() !!}
